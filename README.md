...
# RaccoonWP
**This is 2.8.1 release. If you find any issues let us know**
...
- Theme:
    - Customizable theme build process based on newest [Webpack 5](https://webpack.js.org/) with all its features
